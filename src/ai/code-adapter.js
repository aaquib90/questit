...
const BROWSER_EXECUTION_GUIDANCE = `All functionality must run entirely in the browser:
- Rely only on Web APIs, Web Workers, WebAssembly bundles, or libraries that work in vanilla browser environments (e.g., pdf.js for PDF rendering).
