...
/**
 * Questit logotype rendered inline so its strokes inherit `currentColor`.
 * SVG source: https://bskmmwqlivmhxhiybxel.supabase.co/...Logo.svg
 */
export default function BrandLogo({ title = 'Questit', className, ...props }) {
  return (
    <svg
    ...
    >
      <defs>
        <clipPath id="brand-logo_a">
          <rect x="0" y="0" width="185" height="77" />
        </clipPath>
        <clipPath id="brand-logo_b">
          <path d="M21 29h67v64.5H21Zm0 0" clipRule="nonzero" />
        </clipPath>
        <clipPath id="brand-logo_c">
          <path d="M.543 56H66v8H.543Zm0 0" clipRule="nonzero" />
        </clipPath>
        <clipPath id="brand-logo_d">
          <path d="M4 1h8v63.5H4Zm0 0" clipRule="nonzero" />
        </clipPath>
        <clipPath id="brand-logo_e">
          <rect x="0" y="0" width="67" height="65" />
        </clipPath>
        <clipPath id="brand-logo_f">
          <path d="M1 1h65.539v8H1Zm0 0" clipRule="nonzero" />
        </clipPath>
        <clipPath id="brand-logo_g">
          <path d="M56 0h8v63.672h-8Zm0 0" clipRule="nonzero" />
        </clipPath>
        <clipPath id="brand-logo_h">
          <rect x="0" y="0" width="67" height="64" />
        </clipPath>
      </defs>
      <g transform="matrix(1 0 0 1 45 9)">
        <g clipPath="url(#brand-logo_a)">
          <g fill="currentColor">
      ...
      <g clipPath="url(#brand-logo_b)">
        <g transform="matrix(1 0 0 1 21 29)">
          <g clipPath="url(#brand-logo_e)">
            <g clipPath="url(#brand-logo_c)">
              <path
                strokeLinecap="butt"
      ...
      <g transform="matrix(1 0 0 1 197 0)">
        <g clipPath="url(#brand-logo_h)">
          <g clipPath="url(#brand-logo_f)">
            <path
              strokeLinecap="butt"
              strokeLinejoin="miter"
