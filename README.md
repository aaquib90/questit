...
- The workbench UI now runs on shadcn/ui (Tailwind) with dynamic base-color selection (emerald, sky, violet, amber) so the preview can match the user’s preferred theme.
